...
if (!source.includes("<PersonalAIMarketplace")) {
  const text = "Genera videos con cola de trabajos. Modo actual: texto a video e imagen a video."
  const textIndex = source.indexOf(text)
  if (textIndex < 0) throw new Error("[video-personal-marketplace] encabezado de Video Studio no encontrado")
