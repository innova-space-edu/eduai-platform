...
EduAI Platform es una plataforma educativa de siguiente generación que combina **20+ agentes de inteligencia artificial especializados**, un **Creator Studio con 8 formatos de salida**, y un **sistema de exámenes para docentes con evaluación IA** para ofrecer una experiencia de aprendizaje completamente personalizada, adaptativa y gamificada.

Va más allá de un simple chatbot — es un ecosistema inteligente donde múltiples agentes colaboran para que el estudiante aprenda más rápido y de forma más profunda. Diseñada especialmente para el contexto educativo chileno, incluye cobertura curricular completa del **MINEDUC** (Parvularia, Básica y Media) con escala de notas 1.0-7.0.
...
5. Comparte por WhatsApp/Classroom    6. Abre link (SIN login)
                                      ...
                                      8. Rinde con timer
                                      9. IA evalúa desarrollo y V/F
                                     10. Ve nota + retroalimentación
11. Dashboard con 40 alumnos    ←── resultados en tiempo real
12. Descarga Excel/PDF
```
...
Motor universal de creación de material educativo. Transforma cualquier contenido (tema, texto, URL, PDF, DOCX) en 8 formatos:

| Formato | Descripción | Descargas |
|---------|-------------|-----------|
| 📊 **Infografía** | Visual con datos clave y estadísticas | PNG, JPG, PDF |
| 📑 **Presentación** | Slides profesionales con notas del orador | PPTX, PDF, PNG |
| 🎨 **Afiche/Poster** | Poster visual con puntos destacados | PNG, JPG, PDF |
| 🎙️ **Podcast** | Diálogo entre 2 hosts con voces Edge TTS | MP3, PDF guión, TXT |
| 🧠 **Mapa Mental** | Grafo interactivo de conceptos | PNG, PDF |
| 📇 **Flashcards** | Tarjetas con niveles de dificultad | PDF, PNG |
| ✅ **Quiz** | Evaluación con múltiple opción y V/F | PDF |
| ⏳ **Timeline** | Línea temporal con importancia | PNG, PDF |

- **Pipeline universal** — URL (Cheerio), PDF (pdf-parse), DOCX (Mammoth), texto directo
- **Gemini 2.5 Flash** con fallback a Groq
- **12 paletas de color** aplicadas a vista previa y exports
...
```
Contenido → Gemini genera guión (25+ segmentos)
  → Host A ("El Profesor"): explica con autoridad, datos, analogías
  → Host B ("El Estudiante"): preguntas, reacciones, humor
...
## Sistema Orquestador de 4 Agentes
...
## Los 20+ Agentes de IA

### Agentes de Estudio Activo (12)

| Agente | Función |
|--------|---------|
| 🧠 **AGT** Tutor General | Explica cualquier tema con profundidad adaptativa |
...
| 🔄 **ARE** Repaso Espaciado | Algoritmo SM-2 para repasos óptimos |
...
| 🖼️ **AIm** Visual | Generación automática de imágenes educativas |
...
| 🎨 **Imágenes** | FLUX y Stable Diffusion con galería |
| 🖼️ **Galería** | Imágenes generadas con filtros y descarga |
| ✨ **Creator Studio** | 8 formatos + podcast MP3 |
...
html-to-image      PptxGenJS          jsPDF
xlsx (SheetJS)     framer-motion      lucide-react
```
...
@andresaya/edge-tts (podcast MP3)
...
content_creations   — historial de Creator Studio
flashcard_decks     — decks de flashcards con SM-2
quiz_sessions       — sesiones de quiz
user_xp             — gamificación: XP, nivel, racha, badges
teacher_exams       — exámenes creados por docentes
exam_submissions    — respuestas con notas y evaluación IA
...
chat_messages       — mensajes con reacciones
...
### Storage Buckets
```
papers              — PDFs de papers académicos (privado, RLS)
creations           — archivos del Creator Studio (público)
chat-files          — archivos del chat social
```
...
- Crear buckets: `papers` (privado), `creations` (público), `chat-files` (público)
...
3. En Supabase → Authentication → URL Configuration agregar dominio
...
- [ ] 🗺️ Mapas Conceptuales interactivos con D3.js/vis-network
- [ ] 🃏 Repetición Espaciada SM-2 con scheduling
- [ ] 🏆 Gamificación avanzada (XP por Creator Studio, badges)
- [ ] 📝 Cornell Notes automáticos
- [ ] 🧠 Orquestador central 14 agentes / 5 capas
...
- [x] 🎙️ Podcast MP3 — Edge TTS con 2 voces
- [x] 📋 Exámenes Docente — link público, evaluación IA, notas MINEDUC
- [x] 📄 Chat Paper — Supabase Storage, chunking inteligente, 50MB
- [x] 📊 Infografías, PPT, Posters descargables
- [x] 🎨 12 paletas de color en exports
- [x] 📇 Flashcards y Quiz generados
- [x] 🧠 Mapas mentales interactivos
- [x] ⏳ Timelines con importancia
- [x] 🤖 Orquestador de 4 agentes
...
- [x] 🎨 Generador de imágenes FLUX/SD
- [x] 🔄 AI Router con fallback automático
