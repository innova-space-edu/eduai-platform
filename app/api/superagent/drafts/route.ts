// app/api/superagent/drafts/route.ts
...
export async function GET() {
  return Response.json({
    ...
    endpoint: "/api/superagent/drafts",
    message: "Endpoint de borradores anticipados disponible.",
  })
}
  ...
  try {
    ...
    const message =
      error instanceof Error
        ? error.message
        : "No se pudo crear el borrador anticipado."
