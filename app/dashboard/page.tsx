      ...
      >
        ...
        <div className="border-b border-white/[0.06] bg-gray-950/80 backdrop-blur-xl sticky top-0 z-10">
          <div className="max-w-2xl mx-auto px-6 py-3 flex items-center justify-between">
            <p className="text-gray-600 text-xs font-medium uppercase tracking-widest">Panel</p>
            <div className="flex items-center gap-3">
              <span className="text-gray-500 text-sm">{displayName}</span>
              <div
                className="px-2.5 py-1 rounded-xl text-xs font-semibold"
                style={{ background: `${levelColor.glow}20`, color: levelColor.text.replace("text-", "") === "gray-400" ? "#94a3b8" : undefined }}
              >
              ...
              <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-amber-500/8 border border-amber-500/15">
                ...
                <span className="text-amber-400 text-xs font-bold tabular-nums">{xp}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto w-full px-6 py-8 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-4 gap-3 stagger">
            {[
              ...
              { label: "Sesiones", value: String(sessions), icon: BookMarked,  color: "#10b981" },
            ].map(s => {
              const Icon = s.icon
              return (
                <div
          ...
          >
            <div className="flex justify-between text-xs text-gray-500 mb-2.5">
              <span>Progreso hacia <span className="text-gray-400">{nextLevel?.name || "Maestro"}</span></span>
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-white font-semibold text-sm">Nueva sesión de estudio</h2>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: topic.trim() ? "0 4px 16px rgba(59,130,246,0.25)" : "none",
                }}
              >
                <span>Estudiar</span>
