...
5. Comparte por WhatsApp/Classroom    6. Abre link (SIN login)
									  ...
									  8. Rinde con timer
									  9. Puntaje visible por pregunta ← NUEVO
...
- **Puntaje visible por pregunta:** cada pregunta muestra sus puntos durante la rendición ← NUEVO
- **Navegador de preguntas con puntajes:** los botones del navegador muestran el puntaje de cada pregunta ← NUEVO
- **Desglose de puntaje V/F:** muestra puntos por selección + puntos por justificación ← NUEVO
...
#### Puntaje visible durante el examen (detalle)

El estudiante ahora ve claramente los puntajes en todo momento:

| Elemento | Información mostrada |
|----------|---------------------|
| Barra superior | Nombre · Preguntas respondidas · **Puntaje total del examen** |
| Header de pregunta | Badge destacado con pts de la pregunta actual |
| Preguntas V/F | Desglose: `(X selección + Y justif.)` |
| Navegador inferior | Cada botón muestra el número de pregunta **y sus pts** |
| Tooltip navegador | Al pasar el mouse: "Pregunta N — X pts" |
...
│   │   ├── crear/page.tsx
│   │   ├── docente/page.tsx
│   │   ├── p/[code]/page.tsx     ← puntajes visibles durante examen
